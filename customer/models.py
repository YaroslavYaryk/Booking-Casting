...
class Customer(models.Model):
    ...
    organization_number = models.CharField("Organization number", max_length=255, unique=True)
...
class CustomerAccess(models.Model):
    ...
    customer = models.ForeignKey(Customer, verbose_name="customer_access", on_delete=models.CASCADE)
    access = models.ForeignKey(User, verbose_name=("access"), on_delete=models.CASCADE, null=True)
...
class CustomerRequestsStorage(models.Model):
    ...
    customer = models.ForeignKey(Customer, verbose_name="customer_on_request_storage", on_delete=models.CASCADE)
