...
from event.models import EventRentalProducts, EventTeam, RentalProducts
...
def add_new_event(request):
    ...
    return render(
        request, "admin/pages/event/event/add.html", {"form": form, "users": users}
    )
...
def update_event(request, event_id):
    ...
    return render(
        request, "admin/pages/event/event/update.html", {"form": form, "event": event}
    )
...
def change_rental_product(request, rental_product_id):
    ...
    return render(
        request, "admin/pages/event/rental_products/update.html", {"form": form}
    )
...
def add_new_event_rental_product(request):
    ...
    return render(
        request, "admin/pages/event/event_rental_products/add.html", {"form": form}
    )
...
def change_event_product(request, event_product_id):
    ...
    if request.method == "POST":
        form = EventRentalProductsForm(
            request.POST, request.FILES, instance=event_product
        )
        if form.is_valid():
            form.save()
            return HttpResponseRedirect(reverse("admin_get_all_event_rental_products"))
    ...
    return render(
        request, "admin/pages/event/event_rental_products/update.html", {"form": form}
    )
